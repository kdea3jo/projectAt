				...
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<input type="password" placeholder="비밀번호를 재입력하세요." class="form-control input-lg">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="username" placeholder="실명을 입력하세요." class="form-control input-lg typeahead tt-query" autocomplete="off" spellcheck="false">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input class="form-control input-sm" type="date" name="birthday" id="wrtDtReg" placeholder="클릭하세요." readonly="readonly">							
						</div>
					</div>
					...
					<div class="control-group">
						<!-- Button -->
						<div class="controls">
							<button class="btn btn-success" type="button" id="join" onclick="formcheck()">가입하기</button>
						</div>
					</div>
				</fieldset>
			</form>
